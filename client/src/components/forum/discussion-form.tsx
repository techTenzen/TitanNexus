...
export function DiscussionForm() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      title: "",
      description: "",
      tag: "General", // Set General as default
      imageUrl: "",
    },
  });
  ...
  const createDiscussionMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      // Different toast messages based on tag
      const tagMessages = {
        "General": "Your discussion has been created",
        "Feature Request": "Your feature request has been logged",
        "Issue": "Your issue has been reported"
      };

      const message = tagMessages[variables.tag as keyof typeof tagMessages] || "Your discussion has been created";
